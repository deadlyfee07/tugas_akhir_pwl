    ...
    <div class="w-full max-w-md">
        <div class="bg-white rounded-xl border border-gray-200 p-8">
            <div class="text-center mb-8">
                ...
                <p class="text-gray-500 text-sm mt-1">Masuk ke akun SerbaKlik ID Anda</p>
            </div>
            ...
            <form method="POST" action="/login">
                ...
                <button type="submit" class="w-full mt-6 px-6 py-3 bg-primary-600 text-white font-semibold rounded-lg hover:bg-primary-700 transition">Masuk</button>
            </form>

            <p class="text-center text-sm text-gray-500 mt-6">
                Belum punya akun?
                <a href="/register" class="text-primary-600 hover:underline font-medium">Daftar</a>
            </p>
        </div>
    </div>
</div>
